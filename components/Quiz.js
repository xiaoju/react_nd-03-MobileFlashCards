      ...
      <View style={[MyStyles.background]}>
        {this.state.questionNo > this.state.thisDeck.questions.length ? (
          this.state.thisDeck.questions.length === 0 ? (
            <View style={[MyStyles.infoView]}>
              <Text style={[MyStyles.text]}>
                Add cards before starting the quiz!
              </Text>
              <Text style={[MyStyles.smallText]}>
                For that, press the + button.
              </Text>
              <Text style={[MyStyles.smallText]}>
                Also, you see the double arrow icon below? This will be to
                restart tests.
              </Text>
            </View>
          ) : (
              ...
              <Text style={[MyStyles.text]}>
                {Math.round(
                  this.state.correctCount /
                    this.state.thisDeck.questions.length *
                    100
                )}%
              </Text>
            </View>
          ...
          <View style={[MyStyles.infoView]}>
            ...
            <Text style={[MyStyles.text]}>
              {
                this.state.thisDeck.questions[this.state.questionNo - 1]
                  .question
              }
            </Text>
          </View>
